...
| miner                 | (added)                 | **(Note that)** Because the [consensus mechanism](../../../klaytn/design/consensus-mechanism) in Klaytn is [PBFT](../../../klaytn/design/consensus-mechanism#pbft-practical-byzantine-fault-tolerance), there is a block proposer not miner. So it returns the address of proposer of the block.                                                                                                                                                      |
...
| gasPrice                          | gasPrice                                                                    | **(Note that)** It is also called [Unit Price](../../../klaytn/design/transaction-fees#unit-price) in Klaytn and this value is set in the system by the governance.                                                                                                                                           |
...
|                                   | [senderTxHash](../../../klaytn/design/transactions#sendertxhash)(omitted)   | **(Note that)** This field is omitted because this field does not exist in Ethereum Legacy Transaction.                                                                                                                                                                                                       |
...
### Common Fields For [FeeDelegation](../../../klaytn/design/transactions/fee-delegation)
Regardless of various Klaytn [FeeDelegation](../../../klaytn/design/transactions/fee-delegation) transaction type, there are common fields.
...
### Common Fields For [PartialFeeDelegation](../../../klaytn/design/transactions/partial-fee-delegation)
Regardless of various Klaytn [PartialFeeDelegation](../../../klaytn/design/transactions/partial-fee-delegation) transaction type, there are common fields.
...
| effectiveGasPrice                  | (added)                                                                     | **(Note that)** Since Klaytn uses a fixed gas price policy, the gasPrice value is returned. gasPrice(also called [Unit Price](../../../klaytn/design/transaction-fees#unit-price)) is set in the system by the governance.                  |
| from                               | from                                                                        | (Same with Ethereum) Address of the sender.                                                                                                                                                                                                 |
...
|                                    | [senderTxHash](../../../klaytn/design/transactions#sendertxhash)(omitted)   | **(Note that)** This field is omitted because this field does not exist in Ethereum Transaction Receipt.                                                                                                                                    |
